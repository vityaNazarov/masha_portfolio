          ...
          <div className={css.ezygo}>
            ...
            <div className={css.project_description_block}>
              <p className={css.project_description}>
                ...
                about the functionality and operation of Super apps in general.
              </p>
              <p className={css.project_description}>
            ...
            <div className={css.project_description_block}>
              <p className={css.project_description}>
                <span className={css.project_description_bold}>Problem</span>: A{" "}
                <span className={css.project_description_bold}>
              ...
              <p className={css.project_description}>
                <span className={css.project_description_bold}>Solution</span>:
                To study the competitors, I had to continue studying the Asian
                digital market. Analyzing competitors{" "}
                <span className={css.project_description_bold}>
                  helped me understand
                </span>{" "}
                not only how extensive a super app could be and the basic needs
                of users, but also{" "}
                <span className={css.project_description_bold}>
            ...
            <div className={css.project_description_block}>
              <p className={css.project_description}>
                ...
                , what their requirements are for the functionality of the super
                app.
              </p>
              <p className={css.project_description}>
                <span className={css.project_description_bold}>Solution</span>:
                ...
                I was able to collect became one of their important aspects and
                the basis for creating the app.
              </p>
            </div>
            ...
            <div className={css.project_description_block}>
              <p className={css.project_description}>
                <span className={css.project_description_bold}>Problem</span>:
                To track the patterns, functionality, and architecture of other
              ...
              <p className={css.project_description}>
                ...
                in various similar applications, the analysis and conclusions of
                which helped to create a vision that{" "}
                <span className={css.project_description_bold}>
            ...
            <div className={css.project_description_block}>
              ...
              <p className={css.project_description}>
                ...
                to better understand the future composition and architecture of
                the application. This helped me
                <span className={css.project_description_bold}>
                  to work iteratively
                </span>{" "}
            ...
            <div className={css.project_description_block}>
              ...
              <p className={css.project_description}>
                ...
                <span className={css.project_description_bold}>
                  would not overload the user&#39;s focus from the main actions
                </span>
