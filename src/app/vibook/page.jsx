          ...
          <div className={css.ezygo}>
            ...
            <div className={css.main_img_block}>
              <Image
                ...
                height="468"
              />
              <h2 className={css.main_img_name}>VIBOOK</h2>
            </div>
            ...
            <div className={css.project_description_block}>
              ...
              <p className={css.project_description}>
                ...
                project was the{" "}
                <span className={css.project_description_bold}>
                  study of applications from different niches to learn different
            ...
            <div className={css.project_description_block}>
              ...
              <p className={css.project_description}>
                ...
                <span className={css.project_description_bold}>
                  simple but visually soft font and a fairly bright pink accent
                  color
                </span>
            ...
            <div className={css.project_img_block_center}>
              <Image
            ...
            <div className={css.project_description_block}>
              ...
              <p className={css.project_description}>
                <span className={css.project_description_bold}>Solution</span>:
                While I was making the layout interactive, we saw many errors in
                the flow, which I corrected later, making the layouts and flows
