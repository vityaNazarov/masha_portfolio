        ...
        <div className={css.projects}>
          ...
          <ul className={css.projects__block}>
            <li className={css.project__block_maven}>
              <Link href="/makehire" className={css.project__right_block_maven}>
                <div className={css.project__right_block_link}>
            ...
            <li className={css.project__block}>
              ...
              <Link href="/ezygo" className={css.project__right_block}>
                <div className={css.project__right_block_link}>
                  <span className={css.project__right_text}>Overview</span>
                  <svg
                    width="95"
            ...
            <li className={css.project__block}>
              <Link href="/vibook" className={css.project__right_block_maven}>
                <div className={css.project__right_block_link}>
                  <span className={css.project__right_text}>Overview</span>
                  <svg
                    width="95"
